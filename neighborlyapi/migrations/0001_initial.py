# Generated by Django 3.1.4 on 2020-12-24 01:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(default=1, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='items', to='neighborlyapi.category')),
                ('condition', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='neighborlyapi.condition')),
            ],
        ),
        migrations.CreateModel(
            name='MessageStatus',
